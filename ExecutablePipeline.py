...
class ExecutablePipeline:
    def __init__(self):
        self.shelf_segmenter=HalfShelfSegmenter.HalfShelfSegmenter('/Users/gghosal/Desktop/ProgramFilesPlantPipeline/Vertical2.jpg','/Users/gghosal/Desktop/Template.jpg',1400,800)
    ...
    def process_tray(self, tray_img_path,section_types):
        ...
        for i in trays:
            ...
            #plt.imshow(i)
            #plt.show()
            cleaned,centers_adjustment=ImageProcUtil.threshold_dots3(i)
...
##                                            
    ...
    ##                        
                ...
                cv2.imshow("HI",self.noise_removal.remove_noise(ImageProcUtil.threshold_dots3_slack(i)[0]))
...
if __name__=='__main__':
    ...
    for i in list(listdir_nohidden("/Users/gghosal/Desktop/gaurav_new_photos/UndiagonalizedPhotos")):
        ...
        out_file.close()
    #os.chdir("/Users/gghosal/Desktop/gaurav_new_photos/NewUndiagonalizedPhotos/")
    #trays=a.process_tray("20131027_Shelf6_1500_1_masked.tif",[2,1,2])
